...
public class StoreBaseVPIndexed extends StoreBase
{
    public StoreBaseVPIndexed( HBaseRdfConnection connection, StoreDesc desc, StoreQueryRunner querier, StoreFormatter formatter, StoreLoader loader ) 
    {
        super( connection, desc, querier, formatter, loader, new TableDescLayouts( new TableDescVPIndexed().getTableDesc() ) ) ;
        createPrefixTbl() ;
    }
}
