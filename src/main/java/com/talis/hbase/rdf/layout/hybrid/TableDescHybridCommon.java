...
public class TableDescHybridCommon extends TableDesc
{
	...
	public TableDescHybridCommon( String tName ) { this( tName, COL_FAMILY_NAME_STR ) ; }
	
	public TableDescHybridCommon( String tableName, String colFamily )
	{
