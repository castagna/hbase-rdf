 ...
 */
public class HBaseRdfSorOSingleTableIterator extends AbstractIterator <Triple> 
{
	/** The table scanner for the subject HTable **/
	ResultScanner scanner = null ;
	
	/** An iterator over a single row in the scanner **/
	HBaseRdfSorOSingleRowIterator rowIterator = null ;
	 ...
	 */
	public HBaseRdfSorOSingleTableIterator( ResultScanner tableScanner, Node sm, Node pm, Node om, String columnFamily, HTable nodeTable ) 
	{
		this.scanner = tableScanner ; this.subject = sm ; this.predicate = pm ; this.object = om ; 
		this.columnFamily = columnFamily ; this.nodeTable = nodeTable ;
	}
	...
	public boolean hasNext() 
	{
		try 
		{
			if( rowIterator == null || !rowIterator.hasNext() ) 
			{
				...
				rowIterator = new HBaseRdfSorOSingleRowIterator( rr, subject, predicate, object, columnFamily, nodeTable ) ;
				rr = null ;
			}
