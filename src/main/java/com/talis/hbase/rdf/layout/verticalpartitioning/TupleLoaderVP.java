...
public class TupleLoaderVP extends TupleLoaderBase
{
    protected TableDesc[] tables = null ;

	public TupleLoaderVP( String storeName, HBaseRdfConnection connection, TableDescLayouts tableDesc, int chunkSize ) 
	{
	...
	public void createTables( Node... row ) throws Exception
	{
		...
		for( int i = 0 ; i < 2 ; i++ )
		{
			...
			//Possibly redundant lines since StoreInformationHolder loads all tables that make up a store.
