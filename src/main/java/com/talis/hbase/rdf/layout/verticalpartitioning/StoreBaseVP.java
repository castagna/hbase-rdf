...
public class StoreBaseVP extends StoreBase
{
    public StoreBaseVP( HBaseRdfConnection connection, StoreDesc desc, StoreQueryRunner querier, StoreFormatter formatter, StoreLoader loader ) 
    {
        super( connection, desc, querier, formatter, loader, new TableDescLayouts( new TableDescVP().getTableDesc() ) ) ;
        createPrefixTbl() ;
    }
}
