...
public class TableDescVPCommon extends TableDesc
{
	...
	public TableDescVPCommon( String tName ) { this( tName, COL_FAMILY_NAME_STR ) ; }
	
	public TableDescVPCommon( String tableName, String colFamily )
	{
