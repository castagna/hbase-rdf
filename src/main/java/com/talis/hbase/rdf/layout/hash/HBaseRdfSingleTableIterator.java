...
public class HBaseRdfSingleTableIterator extends AbstractIterator <Triple> 
{
	 ...
	 */
	public HBaseRdfSingleTableIterator( ResultScanner tableScanner, Node sm, Node pm, Node om, String pred, String columnFamily, HTable nodeTable ) 
	{
		this.scanner = tableScanner ; this.subject = sm ; this.predicate = pm ; this.object = om; this.pred = pred ; 
	...
	public boolean hasNext() 
	{
		try 
		{
			if( rowIterator == null || !rowIterator.hasNext() ) 
			{
				...
				rowIterator = new HBaseRdfSingleRowIterator( rr, subject, predicate, object, pred, columnFamily, nodeTable ) ;
				rr = null ;
			}
