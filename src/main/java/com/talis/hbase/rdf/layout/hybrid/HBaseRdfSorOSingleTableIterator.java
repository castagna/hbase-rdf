...
public class HBaseRdfSorOSingleTableIterator extends AbstractIterator <Triple> 
{
	 ...
	 */
	public HBaseRdfSorOSingleTableIterator( ResultScanner tableScanner, Node sm, Node pm, Node om, String columnFamily ) 
	{
	...
	public boolean hasNext() 
	{
		try 
		{
			if( rowIterator == null || !rowIterator.hasNext() ) 
			{
				...
				rowIterator = new HBaseRdfSorOSingleRowIterator( rr, subject, predicate, object, columnFamily ) ;
				rr = null ;
			}
