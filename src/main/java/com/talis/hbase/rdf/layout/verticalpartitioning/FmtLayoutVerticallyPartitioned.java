...
public class FmtLayoutVerticallyPartitioned extends FmtLayout
{
	public FmtLayoutVerticallyPartitioned( String storeName, HBaseRdfConnection connection ) { super( storeName, connection ) ; }
