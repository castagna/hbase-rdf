...
{
    public StoreBaseHash( HBaseRdfConnection connection, StoreDesc desc, StoreQueryRunner querier, StoreFormatter formatter, StoreLoader loader ) 
    {
        super( connection, desc, querier, formatter, loader, new TableDescLayouts( new TableDescHash().getTableDesc() ) ) ;
    }
}
