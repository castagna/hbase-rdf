...
public class TableDescHashCommon extends TableDesc
{
	...
	public TableDescHashCommon( String tName ) { this( tName, COL_FAMILY_NAME_STR ) ; }
	
	public TableDescHashCommon( String tableName, String colFamily )
	{
