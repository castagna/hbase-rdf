...
public class HBaseRdfSorOSingleRowIterator extends AbstractIterator<Triple> 
{
	 ...
	 */
	public HBaseRdfSorOSingleRowIterator( Result rr, Node sm, Node pm, Node om, String columnFamily )
	{
	...
	public Triple _next()
	{
		...
		{			
			...
			String[] remTripleParts = currTriple.split( TableDescHybridCommon.TRIPLE_SEPARATOR ) ;
