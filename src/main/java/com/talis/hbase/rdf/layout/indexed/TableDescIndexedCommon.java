...
public class TableDescIndexedCommon extends TableDesc 
{
	...
	public TableDescIndexedCommon( String tName ) { this( tName, COL_FAMILY_NAME_STR ) ; }
	
	public TableDescIndexedCommon( String tableName, String colFamily )
	{
