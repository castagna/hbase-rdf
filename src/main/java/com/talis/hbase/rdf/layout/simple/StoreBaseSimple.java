...
public class StoreBaseSimple extends StoreBase
{
    public StoreBaseSimple( HBaseRdfConnection connection, StoreDesc desc, StoreQueryRunner querier, StoreFormatter formatter, StoreLoader loader ) 
    {
        super( connection, desc, querier, formatter, loader, new TableDescLayouts( new TableDescSimple().getTableDesc() ) ) ;
    }
}
