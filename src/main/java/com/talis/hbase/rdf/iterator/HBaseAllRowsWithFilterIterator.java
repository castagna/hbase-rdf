 ...
 */
public class HBaseAllRowsWithFilterIterator extends AbstractIterator<Node> {
	 ...
	 */
	public HBaseAllRowsWithFilterIterator( ResultScanner tableScanner, Node sm, Node pm, Node om ) 
	{
