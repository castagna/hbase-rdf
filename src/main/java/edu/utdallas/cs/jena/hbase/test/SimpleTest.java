package edu.utdallas.cs.jena.hbase.test;
...
import edu.utdallas.cs.jena.hbase.ModelHBase;
...
public class SimpleTest 
{
	...
	{
		Model model = new ModelHBase( "test", "cloudmaster.local:60000", "hdfs://cloudmaster.local:9000/hbase" );
